...
- Location: tests\ui\fundtransfer.spec.ts:32:10
...
```ts
  ...
  53  |         console.log(`Transfer message: "${Fundtransferpage.transfersuccess_msg.textContent()}" (should NOT be "Transfer Complete!")`);
...
> 55  |         await expect(Fundtransferpage.transfersuccess_msg).not.toHaveText('Transfer Complete!');
  ...
  77  |         console.log(`Transfer message: "${Fundtransferpage.transfersuccess_msg.textContent()}" (should NOT be "Transfer Complete!")`);
  ...
  102 |         console.log(`Transfer message: "${Fundtransferpage.transfersuccess_msg.textContent()}" (should NOT be "Transfer Complete!")`);
  ...
  107 |         console.log('Transfering to Same Account')
  ...
  118 |         await Accountservicepage.transferfunds.click();
  119 |         await Fundtransferpage.transfer_fund(fromAccount,toAccount,accountbalance);
  120 |         await Fundtransferpage.transferButton.click();
  121 |         await expect(Fundtransferpage.transfersuccess_msg).not.toHaveText('Transfer Complete!');
  122 |     });
  123 | });
```