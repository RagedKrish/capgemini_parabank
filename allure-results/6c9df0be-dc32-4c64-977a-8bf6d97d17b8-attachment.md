...
- Name: api\getcustomeraccount.spec.ts >> testing customer and account apis >> Validate All Account Fields in API
- Location: tests\api\getcustomeraccount.spec.ts:48:9

# Error details

```
TypeError: response1 is not iterable
```
