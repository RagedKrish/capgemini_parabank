...
- Name: api\getcustomeraccount.spec.ts >> testing customer and account apis >> GET Accounts — Invalid Customer ID
- Location: tests\api\getcustomeraccount.spec.ts:66:9
